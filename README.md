...
## Example additional variables for deploying full stack
...
ssh_users:
  ajanis:
    ...
    givenname: "Alan"
    sn: "Janis"
    mail: "alan.janis@prettybaked.com"
    shell: /bin/zsh
    gecos: ajanis
    uid: 1043
    gid: 1042
...
#### Docker Containers for media server/services
```yaml
docker_containers:
  plex:
    description: "Plex Media Server"
...
## Example Playbook for basic deploy with reverse proxy
```yaml
